...
import { AnimatedItem, containerVariants } from "./AnimatedItem"
...
export default function ContactPage() {
  ...
  return (
    <main>
      ...
      {/* Hero Section */}
      <motion.section className="py-10 xs:py-8 bg-muted/30" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }}>
        <div className="max-w-7xl mx-auto px-2 xs:px-3 sm:px-4 lg:px-8">
          <AnimatedItem className="text-center mb-8 xs:mb-6">
            <AnimatedItem>
      ...
      {/* Contact Section */}
      <motion.section className="py-10 xs:py-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }}>
        <div className="max-w-7xl mx-auto px-2 xs:px-3 sm:px-4 lg:px-8">
          <div className="max-w-2xl mx-auto">
              ...
              <AnimatedItem>
                <div className="relative inline-block w-full max-w-xs xs:max-w-sm">
                  <Button asChild size="sm" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 xs:px-2 xs:py-1">
                    <a href="tel:+61410664649" className="inline-flex items-center justify-center w-full space-x-2 text-sm xs:text-xs" onClick={handleCallClick}>
            ...
            <div className="flex flex-col xs:flex-col sm:flex-row gap-4 xs:gap-3 sm:gap-8">
              <div className="space-y-4 xs:space-y-3 sm:space-y-8 w-full">
                  ...
                  <div className="flex items-start space-x-3 xs:space-x-2">
                    <AnimatedItem>
                      <div className="w-9 h-9 xs:w-8 xs:h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                        <MapPin className="w-5 h-5 xs:w-4 xs:h-4 text-primary-foreground" />
                      </div>
                    </AnimatedItem>
                    <div>
                      <AnimatedItem>
                        <h3 className="font-semibold text-foreground mb-1 text-base xs:text-sm">Address</h3>
                      </AnimatedItem>
                      <AnimatedItem>
                ...
                <AnimatedItem>
                  <div className="flex items-start space-x-3 xs:space-x-2">
                    <AnimatedItem>
                      <div className="w-9 h-9 xs:w-8 xs:h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                        <Phone className="w-5 h-5 xs:w-4 xs:h-4 text-primary-foreground" />
                      </div>
                    </AnimatedItem>
                    <div>
                      <AnimatedItem>
                        <h3 className="font-semibold text-foreground mb-1 text-base xs:text-sm">Phone</h3>
                      </AnimatedItem>
                      <AnimatedItem>
                        <p className="text-muted-foreground text-sm xs:text-xs">
                          <a href="tel:+61410664649" className="hover:text-primary transition-colors">0410 664 649</a>
                        </p>
                      </AnimatedItem>
                    </div>
                  </div>
                ...
                <AnimatedItem>
                  <div className="flex items-start space-x-3 xs:space-x-2">
                    <AnimatedItem>
                      <div className="w-9 h-9 xs:w-8 xs:h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                        <Mail className="w-5 h-5 xs:w-4 xs:h-4 text-primary-foreground" />
                      </div>
                    </AnimatedItem>
                    <div>
                      <AnimatedItem>
                        <h3 className="font-semibold text-foreground mb-1 text-base xs:text-sm">Email</h3>
                      </AnimatedItem>
                      <AnimatedItem>
                        <p className="text-muted-foreground text-sm xs:text-xs">
                          <a href="mailto:buildyourdreamhome2@gmail.com" className="hover:text-primary transition-colors">buildyourdreamhome2@gmail.com</a>
                        </p>
                      </AnimatedItem>
                    </div>
                  </div>
                ...
                <AnimatedItem>
                  <div className="flex items-start space-x-3 xs:space-x-2">
                    <AnimatedItem>
                      <div className="w-9 h-9 xs:w-8 xs:h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                        <svg className="w-5 h-5 xs:w-4 xs:h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <AnimatedItem>
                        <a href="https://wa.me/61410664649" target="_blank" rel="noopener noreferrer" className="font-semibold text-foreground mb-1 block text-sm xs:text-xs">WhatsApp</a>
                      </AnimatedItem>
                    </div>
                  </div>
                </AnimatedItem>
              ...
              <div className="flex flex-col items-end space-y-10">
                {/* You can animate additional content here if needed */}
              </div>
            </div>
          </div>
        </div>
