    ...
    <section className="py-16 bg-muted/30" id="about-preview">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">About Build Your Dream Building</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Build Your Dream Building (BYD B PTY LTD) is a trusted construction company specializing in building
